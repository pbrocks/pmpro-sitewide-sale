 ...
 * @author  Paid Memberships Pro <info@paidmembershipspro.com>
 * @license   GPL-2.0+
 */
class PMPro_SWS_Banners {
	/**
	 * [init] Method to initiate actions.
	 *
	 * @return void
	 */
	...
	/**
	 * [get_registered_banners] Gets info about available banners including name and available css selectors.
	 *
	 * @return array
	 *
	 * banner_name => array(
	 * option_title=>string, callback=>string, css_selctors=>array(strings)
	 * )
	 */
	public static function get_registered_banners() {
		...
		$registered_banners = array(
			'top'          => array(
				'option_title'  => __( 'Yes, Top of Site', 'pmpro-sitewide-sales' ),
			...
			'bottom'       => array(
				'option_title'  => __( 'Yes, Bottom of Site', 'pmpro-sitewide-sales' ),
			...
			'bottom_right' => array(
				'option_title'  => __( 'Yes, Bottom Right of Site', 'pmpro-sitewide-sales' ),
	...
	/**
	 * [choose_banner] Logic for when to show banners/which banner to show.
	 *
	...
	/**
	 * [apply_custom_css] Applies user's custom css to banner.
	 *
	 * @return string
	 */
	...
	/**
	 * [hook_top_banner] Sets top banner to be added.
	 *
	 * @return void
	 */
	...
	/**
	 * [show_top_banner] Adds top banner.
	 *
	 * @return [type] [description]
	 */
	public static function show_top_banner() {
		...
		">
			<div class="pmpro_sws_banner-inner">
				<h3><?php esc_html_e( get_post_meta( $active_sitewide_sale, 'pmpro_sws_banner_title', true ) ); ?></h3>
				<?php echo esc_attr_e( get_post_field( 'post_content', $active_sitewide_sale ) ); ?>
				<span class="pmpro_sws_banner-button"><a class="pmpro_btn" href="<?php echo esc_url( get_permalink( get_post_meta( $active_sitewide_sale, 'pmpro_sws_landing_page_post_id', true ) ) ); ?>"><?php esc_html_e( get_post_meta( $active_sitewide_sale, 'pmpro_sws_link_text', true ), 'pmpro-sitewide-sales' ); ?></a></span>
			</div>
	...
	/**
	 * [hook_bottom_banner] Sets bottom banner to be added.
	 *
	 * @return void
	 */
	...
	/**
	 * [show_bottom_banner] Creates the bottom banner.
	 *
	 * @return void Adds banner to page.
	 */
		...
		">
			...
			<a href="javascript:void(0);" onclick="document.getElementById('pmpro_sws_banner_bottom').style.display = 'none';" class="dismiss" title="Dismiss"></a>
				<div class="pmpro_sws_banner-inner-left">
					<h3><?php esc_html_e( get_post_meta( $active_sitewide_sale, 'pmpro_sws_banner_title', true ), 'pmpro-sitewide-sales' ); ?></h3>
				...
				<div class="pmpro_sws_banner-inner-right">
					<span class="pmpro_sws_banner-button"><a class="pmpro_btn" href="<?php echo get_permalink( get_post_meta( $active_sitewide_sale, 'landing_page_post_id', true ) ); ?>"><?php esc_html_e( get_post_meta( $active_sitewide_sale, 'pmpro_sws_link_text', true ), 'pmpro-sitewide-sales' ); ?></a></span>
				</div>
	...
	/**
	 * [hook_bottom_right_banner] Sets bottom right banner to be added.
	 *
	 * @return void
	 */
	...
	/**
	 * [show_bottom_right_banner] Creates the bottom right banner.
	 *
	 * @return void Adds banner to page.
	 */
